...
router.post("/", async (req, res) => {
  try {
    ...
    const newUser = new User({ firstname, lastname, companyName, email, username, password: hashedPassword , is_blocked : false , is_company : true , is_paid : false , oldpassword : ""});
    await newUser.save();
